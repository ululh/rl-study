...
class Bandit:
    ...
    def __init__(self, k_arm=10, epsilon=0., initial=0., step_size=0.1, sample_averages=False, UCB_param=None,
        ...
        self.__sample_averages = sample_averages
        self.__indices = np.arange(self.__k)
        self.__time = 0
        self.__UCB_param = UCB_param
        self.__gradient = gradient
        self.__gradient_baseline = gradient_baseline
    ...
    def step(self, action):
        ...
        self.time += 1
        self.average_reward = (self.time - 1.0) / self.time * self.average_reward + reward / self.time        self.action_count[action] += 1
